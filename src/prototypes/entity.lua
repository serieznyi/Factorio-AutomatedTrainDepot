...
automated_train_depot_building.name = mod_defines.entity_names.depot_building
...
automated_train_depot_building_input.name = mod_defines.entity_names.depot_building_input
...
automated_train_depot_building_output.name = mod_defines.entity_names.depot_building_output
...
automated_train_depot_building_train_stop_input.name = mod_defines.entity_names.depot_building_train_stop_input
--automated_train_depot_building_output.flags = {"hidden"} TODO make hidden

local automated_train_depot_building_train_stop_output = table.deepcopy(data.raw["train-stop"]["train-stop"])
automated_train_depot_building_train_stop_output.name = mod_defines.entity_names.depot_building_train_stop_output
--automated_train_depot_building_output.flags = {"hidden"} TODO make hidden
