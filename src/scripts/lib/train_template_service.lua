...
function TrainTemplateService.planned_quantity_form_tasks(train_template_id)
    ...
    local controlled_trains = persistence_storage.find_controlled_trains(context, train_template.id)

    return train_template.trains_quantity - tasks_quantity - #controlled_trains
end
...
function TrainTemplateService.planned_quantity_disband_tasks(train_template_id)
    ...
    return #controlled_trains - train_template.trains_quantity - tasks_quantity
end
